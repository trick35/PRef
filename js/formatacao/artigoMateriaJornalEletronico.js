function artigoMateriaJornalEletronicoRef(){
    ...
    if (cdrom.checked || online.checked) {
        if (cdrom.checked) {
            resultParcial2 = resultParcial + " CD-ROM."
        } else {
            if (fonte == "" || diaAcesso == "" || mesAcesso == "" || anoAcesso == "") {
                alert('Preencha todos os campos corretamente')
                autoresFormt = undefined;
            } else {
                resultParcial2 = resultParcial + " Disponível em: " + fonte + ". Acesso em: " + diaAcesso + " " + mesAcesso + ". " + anoAcesso + "."
            }
        }
    } else {
