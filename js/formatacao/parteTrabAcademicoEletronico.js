function parteTrabAcademicoEletronicoRef(){
    ...
    var folhaFormat;
    if(folha == ""){
        swal("Erro!", "Informe a folha!", "error");
        return;
    } else {
        folhaFormat = anoFormat + "f. " + folha + "."
    }
    ...
    //RESULTADO
    result = resultParte + "<i>In</i>: " + result;
